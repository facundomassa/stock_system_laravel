            ...
            <div class="flex-grow-1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control @error('quantity_alert') is-invalid @enderror"
                                        name="quantity_alert" id="quantity_alert"
                                        value="{{ old('quantity_alert', $stock->quantity_alert) }}" min="0" required>
                ...
                <div class="d-flex gap-2">
                    @if(auth()->user()->hasRole('tecnico'))
                        <a href="{{ route('technical.dashboard') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @forelse ($movements as $movement)
                                ...
                                <tr>
                                    <td>{{ $movement->id }}</td>
                                    <td>
                                        <a href="{{ route('refer.show', $refer->id ?? '#') }}" class="text-decoration-none">
                                            {{ $refer->id ?? 'N/A' }}
                                        </a>
                                    </td>
